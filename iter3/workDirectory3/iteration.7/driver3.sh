...
dprepro $parameters_file harmonicAcousticSimInputDeck3.template HexLiner_NIT_HarmonicAcousticSimulation3.xml

cfs -d HexLiner_NIT_HarmonicAcousticSimulation3 > HexLiner_NIT_HarmonicAcousticSimulation3.log
